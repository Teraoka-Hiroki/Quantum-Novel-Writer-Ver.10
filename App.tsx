  ...
  const handleGenerateCandidates = async (type: 'Scene Craft' | 'Character Dynamics', append: boolean) => {
    ...
    try {
        ...
        if (res.status === 'success') {
             ...
             // 人物生成（後半）の場合のみ、完了後に最適化タブへ遷移させる
             if (type === 'Character Dynamics') {
                 setActiveTab(1);
             }
        } else {
                ...
                <div className="flex justify-between items-center h-16">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">
                            量子アニーリング駆動型 小説場面作成支援アプリ <span className="text-xs text-gray-500 font-mono ml-2">Ver.10</span>
                        </h1>
                    </div>
                </div>
